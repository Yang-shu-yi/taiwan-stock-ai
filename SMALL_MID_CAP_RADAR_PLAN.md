...
總分 100：
- 品質分數 30%：價格不過熱、20 日動能、成交值、市值、PE 合理、波動不過高。
- 估值分數 20%：市值區間、PER、PBR、殖利率。
- 流動性分數 15%：20 日均成交值。
- 技術分數 25%：MA20、MA60、趨勢、RSI、量比、波動。
- 題材分數：新聞/主題命中最多加 16 分。
...
- 分數達標的中小型股可透過 `SMALL_MID_PROMOTE_LIMIT` 推進 `tw_candidates`。
- 盤前/盤後報告新增「中小型優質股雷達」Top 3。
- Dashboard 新增「中小雷達」頁籤。
- 新增單元測試覆蓋評分、流動性排除、promotion、報告文字。
